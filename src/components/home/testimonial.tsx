...
const HomeTestimonial: FC = () => {
  ...
  return (
    <Box id="testimonial" sx={{ pb: { xs: 6, md: 5 }, backgroundColor: 'background.paper' }}>
      <Container>
        <Grid container spacing={5}>
          ...
          <Grid item xs={12} md={6} sx={{ display: { xs: 'none', md: 'block' } }}>
            <Box sx={{ width: { xs: '100%', md: '90%' } }}>
              <Image src="/images/home-testimonial1.png" width={520} height={540} quality={97} alt="Testimonial img" />
            </Box>
          </Grid>
        </Grid>
      </Container>
